...
public class Item
{
    ...
    public GameObject itemModel;                                ///itemModel of the item - maybe change this to a sprite (same as icon) but it might affect picking stuff up,
                                                                ///things might be referencing a gameobject when a pickup is attempted.
