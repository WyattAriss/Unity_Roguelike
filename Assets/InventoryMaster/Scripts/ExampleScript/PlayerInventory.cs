...
public class PlayerInventory : MonoBehaviour
{
    ...
    public int damageType = 1;                                      //1 is physical, 2 is magic, 3 is fire ...

    public int healthGained = 0;
    public int manaGained = 0;
    ...
    public void OpenClosePlayerEquipment()
    {
    ...
    public void OnConsumeItem(Item item)
    {
        for (int i = 0; i < item.itemAttributes.Count; i++)
        {
            ...
            {
                healthGained = item.itemAttributes[i].attributeValue;
            ...
            {
                manaGained = item.itemAttributes[i].attributeValue;
    ...
    public void OnGearItem(Item item)
    {
        for (int i = 0; i < item.itemAttributes.Count; i++)
        {
            ...
            if (item.itemAttributes[i].attributeName == "MinDamage")
                minDamage += item.itemAttributes[i].attributeValue;
            if (item.itemAttributes[i].attributeName == "MaxDamage")
                maxDamage += item.itemAttributes[i].attributeValue;
            if (item.itemAttributes[i].attributeName == "DamageType")
                damageType = item.itemAttributes[i].attributeValue;
        }
        //if (HPMANACanvas != null)
        //{
        //    UpdateManaBar();
